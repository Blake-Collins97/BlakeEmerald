...
const u32 gTrainerFrontPic_LeaderCody[] = INCBIN_U32("graphics/trainers/front_pics/leader_juan_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderCody[] = INCBIN_U32("graphics/trainers/palettes/leader_juan.gbapal.lz");
