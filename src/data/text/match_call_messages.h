...
const u8 gText_MatchCallSchoolKid_Karen_Intro1[] = _("My Grubdy gives me spending");
...
const u8 gText_MatchCallReliableOne_Grub_Strategy[] = _("I flexibly adapt my style.");
const u8 gText_MatchCallReliableOne_Grub_Pokemon[] = _("Grown in a balanced manner.");
const u8 gText_MatchCallReliableOne_Grub_Intro1[] = _("I walk the 30 minutes from");
const u8 gText_MatchCallReliableOne_Grub_Intro2[] = _("home to here every day.");
...
const u8 gText_MatchCallEliteFour_Chels_Strategy[] = _("I use items for help.");
const u8 gText_MatchCallEliteFour_Chels_Pokemon[] = _("Flaming passion in icy cold!");
const u8 gText_MatchCallEliteFour_Chels_Intro1[] = _("The ICE type can be better");
const u8 gText_MatchCallEliteFour_Chels_Intro2[] = _("trained in this hot land.");
