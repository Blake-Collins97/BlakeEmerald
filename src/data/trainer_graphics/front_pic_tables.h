const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ELITE_FOUR_Chels] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ELITE_FOUR_Chels, gTrainerFrontPic_EliteFourChels, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ELITE_FOUR_Chels, gTrainerPalette_EliteFourChels),
