...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .moves = MOVE_DRAGON_DANCE, MOVE_CRUNCH, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE
    },
    {
    .lvl = 1,
    ...
    .moves = MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_QUIVER_DANCE
    },
    {
    .lvl = 1,
    ...
    .moves = MOVE_LUSTER_PURGE, MOVE_DRACO_METEOR, MOVE_THUNDERBOLT, MOVE_ICE_BEAM
    },
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .ability = 0, // Sand Stream,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_FIRE_PUNCH, MOVE_LOW_KICK  
    },
    {
    .lvl = 1,
    .species = SPECIES_LUCARIO,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_AURA_SPHERE, MOVE_FLASH_CANNON, MOVE_NASTY_PLOT, MOVE_VACUUM_WAVE
    },
    {
    .lvl = 1,
    .species = SPECIES_GALLADE,
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_ICY_WIND, MOVE_THUNDERBOLT
    },
    {
    .lvl = 1,
    .species = SPECIES_METAGROSS,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_METEOR_MASH, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT
    },
    {
    .lvl = 2,
    .species = SPECIES_HO_OH,
    ...
    .ability = 2, // Regenerator
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_SACRED_FIRE, MOVE_BRAVE_BIRD, MOVE_EXTRASENSORY, MOVE_ANCIENT_POWER  
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .ability = 1, // Sand Rush
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_DARK_PULSE, MOVE_SHADOW_BALL
    },
    {
    .lvl = 1,
    .species = SPECIES_DECIDUEYE,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BODY_SLAM, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE, MOVE_PLAY_ROUGH
    },
    {
    .lvl = 2,
    .species = SPECIES_GLALIE,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .ability = 1, // Sturdy
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_ROCK_SLIDE, MOVE_SHORE_UP
    },
    {
    .lvl = 1,
    .species = SPECIES_SALAMENCE,
    ...
    .ability = 0, // Intimidate
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_HURRICANE, MOVE_THUNDER_WAVE
    },
    {
    .lvl = 1,
    .species = SPECIES_FERALIGATR,
    ...
    .ability = 2, // Rough Skin
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_OUTRAGE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE
    },
    {
    .lvl = 1,
    .species = SPECIES_DHELMISE,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_ANCHOR_SHOT, MOVE_POWER_WHIP, MOVE_SHADOW_CLAW, MOVE_KNOCK_OFF
    },
    {
    .lvl = 2,
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_LUCARIONITE,
    .ability = 1, // Inner Focus -> Adaptability
    .spread = SPREAD_31_IV_ATK_SPEED_NAIVE,
...
static const struct TrainerMonItemCustomMoves sParty_Red[] = {
   {
    ...
    .species = SPECIES_PIKACHU,
    .heldItem = ITEM_LIGHT_BALL,
    .ability = 2, // Lightening Rod
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_VOLT_TACKLE, MOVE_IRON_TAIL, MOVE_PLAY_ROUGH, MOVE_EXTREME_SPEED
    },
    {
    .lvl = 3,
    .species = SPECIES_POLIWRATH,
    ...
    .ability = 0, // Water Absorb
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_CLOSE_COMBAT, MOVE_ICE_PUNCH
    },
    {
    .lvl = 3,
    .species = SPECIES_ESPEON,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0, // Magic Bounce 
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_GRASS_KNOT, MOVE_DAZZLING_GLEAM
    },
    {
    .lvl = 3,
    .species = SPECIES_SNORLAX,
    ...
    .ability = 1, // Thick Fat
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DOUBLE_EDGE, MOVE_STRENGTH, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM
    },
    {
    .lvl = 3,
    .species = SPECIES_AERODACTYL,
    ...
    .ability = 0, // Rock Head  
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DUAL_WINGBEAT, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_DOUBLE_EDGE
    },
    {
    .lvl = 3,
    .species = SPECIES_CHARIZARD,
    ...
    .ability = 0, // Blaze 
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_SCORCHING_SANDS, MOVE_FOCUS_BLAST
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Blue[] = {
    ...
    .species = SPECIES_SCIZOR,
    .heldItem = ITEM_METAL_COAT,
    .ability = 1, // Technitian
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BULLET_PUNCH, MOVE_DUAL_WINGBEAT, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE
    },
    {
    .lvl = 3,
    .species = SPECIES_PIDGEOT,
    ...
    .ability = 0, // Trace
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_TRI_ATTACK, MOVE_SHADOW_BALL, MOVE_RECOVER, MOVE_THUNDER_WAVE
    },
    {
    .lvl = 3,
    .species = SPECIES_RHYPERIOR,
    ...
    .ability = 1, // Solid Rock
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_STRENGTH, MOVE_HAMMER_ARM, MOVE_HEAT_CRASH
    },
    {
    .lvl = 3,
    .species = SPECIES_MACHAMP,
    ...
    .ability = 1, // No Guard
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_POISON_JAB
    },
    {
    .lvl = 3,
    .species = SPECIES_BLASTOISE,
...
static const struct TrainerMonItemCustomMoves sParty_Green[] = {
   {
    ...
    .ability = 1, // Magic Guard
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_HYPER_BEAM, MOVE_CALM_MIND, MOVE_MOONBLAST, MOVE_SOFT_BOILED
    },
    {
    .lvl = 3,
    .species = SPECIES_WIGGLYTUFF,
    ...
    .ability = 0, // Fur Coat
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_HYPER_BEAM, MOVE_DAZZLING_GLEAM, MOVE_TOXIC, MOVE_WISH
    },
    {
    .lvl = 3,
    .species = SPECIES_ALAKAZAM,
    ...
    .ability = 2, // Imposter
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EXPLOSION, MOVE_STRENGTH, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM
    },
    {
    .lvl = 3,
    .species = SPECIES_NIDOQUEEN,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2, // Shear Force 
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER
    },
    {
    .lvl = 3,
    .species = SPECIES_VENUSAUR,
    ...
    .ability = 0, // Overgrow 
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_LEAF_STORM, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_SLEEP_POWDER
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_GreenAlteringCave[] = {
    {
    .lvl = 5,
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_LEFTOVERS,
