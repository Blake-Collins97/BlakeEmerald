...
static const struct SpriteFrameImage sPicTable_Chels[] = {
    overworld_frame(gObjectEventPic_Chels, 2, 4, 0),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 1),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 2),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 0),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 0),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 1),
    overworld_frame(gObjectEventPic_Chels, 2, 4, 1),
