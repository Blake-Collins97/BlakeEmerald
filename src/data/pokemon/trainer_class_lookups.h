const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ELITE_FOUR_Dan] = TRAINER_PIC_ELITE_FOUR_Dan,
    [FACILITY_CLASS_ELITE_FOUR_Sharni] = TRAINER_PIC_ELITE_FOUR_Sharni,
    ...
    [FACILITY_CLASS_CHAMPION_Blake] = TRAINER_PIC_CHAMPION_Blake,
    ...
    [FACILITY_CLASS_Guy] = TRAINER_PIC_Guy,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_ELITE_FOUR_Dan] = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_Sharni] = TRAINER_CLASS_ELITE_FOUR,
    ...
    [FACILITY_CLASS_CHAMPION_Blake] = TRAINER_CLASS_CHAMPION,
    ...
    [FACILITY_CLASS_Guy] = TRAINER_CLASS_PKMN_TRAINER_3,
