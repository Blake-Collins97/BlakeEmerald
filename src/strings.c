...
const u8 gText_GrubsAdvice[] = _("Grub's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Sharni[] = _("Phoebe");
const u8 gText_Chels[] = _("Chels");
...
const u8 gText_SavingVersionNum[] = _("Ver 1.11");
...
const u8 gText_GrubMatchCallName[] = _("Grub");
