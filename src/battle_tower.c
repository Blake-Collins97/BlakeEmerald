...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_ELITE_FOUR_M, FACILITY_CLASS_ELITE_FOUR_Dan},
    {RS_FACILITY_CLASS_ELITE_FOUR_F, FACILITY_CLASS_ELITE_FOUR_Sharni},
    ...
    {RS_FACILITY_CLASS_CHAMPION, FACILITY_CLASS_CHAMPION_Blake},
    ...
    {RS_FACILITY_CLASS_Guy, FACILITY_CLASS_Guy},
