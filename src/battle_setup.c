...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_Grub] = REMATCH(TRAINER_Grub_1, TRAINER_Grub_2, TRAINER_Grub_3, TRAINER_Grub_4, PETALBURG_CITY),
    ...
    [REMATCH_Cody] = REMATCH(TRAINER_Cody_1, TRAINER_Cody_2, TRAINER_Cody_3, TRAINER_Cody_4, SOOTOPOLIS_CITY),
    [REMATCH_Dan] = REMATCH(TRAINER_Dan, TRAINER_Dan_2, TRAINER_Dan_3, TRAINER_Dan_4, EVER_GRANDE_CITY),
    [REMATCH_Sharni] = REMATCH(TRAINER_Sharni, TRAINER_Sharni_2, TRAINER_Sharni_3, TRAINER_Sharni_4, EVER_GRANDE_CITY),
    [REMATCH_Chelsea] = REMATCH(TRAINER_Chelsea, TRAINER_Chelsea_2, TRAINER_Chelsea_3, TRAINER_Chelsea_4,  EVER_GRANDE_CITY),
    [REMATCH_Ray] = REMATCH(TRAINER_Ray, TRAINER_Ray_2, TRAINER_Ray_3, TRAINER_Ray_4, EVER_GRANDE_CITY),
    [REMATCH_Blake] = REMATCH(TRAINER_Blake, TRAINER_Blake, TRAINER_Blake, TRAINER_Blake, EVER_GRANDE_CITY),
};
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ELITE_FOUR)
    {
        switch (gTrainerBattleOpponent_A)
        {
            ...
            case TRAINER_Dan_3:
            case TRAINER_Dan_4:
                return B_TRANSITION_Dan;
            case TRAINER_Sharni:
            case TRAINER_Sharni_2:
            case TRAINER_Sharni_3:
            case TRAINER_Sharni_4:
                return B_TRANSITION_Sharni;
            case TRAINER_Chelsea:
            case TRAINER_Chelsea_2:
            case TRAINER_Chelsea_3:
            case TRAINER_Chelsea_4:
                return B_TRANSITION_Chelsea;
            case TRAINER_Ray:
            case TRAINER_Ray_2:
            case TRAINER_Ray_3:
            case TRAINER_Ray_4:
                return B_TRANSITION_Ray;
        }
    }
