...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_Chels] = REMATCH(TRAINER_Chels, TRAINER_Chels_2, TRAINER_Chels_3, TRAINER_Chels_4,  EVER_GRANDE_CITY),
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ELITE_FOUR)
    {
        switch (gTrainerBattleOpponent_A)
        {
            ...
            case TRAINER_Chels:
            case TRAINER_Chels_2:
            case TRAINER_Chels_3:
            case TRAINER_Chels_4:
                return B_TRANSITION_Chels;
            case TRAINER_Ray:
            case TRAINER_Ray_2:
            case TRAINER_Ray_3:
            case TRAINER_Ray_4:
