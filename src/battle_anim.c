...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_PurpleRay, 0x800, ANIM_TAG_DRAGON_ASCENT},
    ...
    {gBattleAnimSpriteGfx_PurpleRay, 0x800, ANIM_TAG_DRAGON_ASCENT_FOE},
    ...
    {gBattleAnimSpriteGfx_PurpleRay, 0x800, ANIM_TAG_PURPLE_Ray},
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_GreenRay,	ANIM_TAG_DRAGON_ASCENT},
    ...
    {gBattleAnimSpritePal_PurpleRay, ANIM_TAG_PURPLE_Ray},
