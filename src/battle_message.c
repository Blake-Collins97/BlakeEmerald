...
static const u8 sText_GuyUsedItem[] = _("Guy used\n{B_LAST_ITEM}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_GuyUSEDITEM - 12] = sText_GuyUsedItem,
...
const u8 gText_WhatWillGuyDo[] = _("What will\nGuy do?");
...
const u8 gText_BattleGuyName[] = _("Guy");
